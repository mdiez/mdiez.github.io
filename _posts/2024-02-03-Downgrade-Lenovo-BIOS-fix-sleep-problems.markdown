![image](https://github.com/mdiez/mdiez.github.io/assets/7477044/490e43e4-4c12-4384-995f-ea70f7fc96e0)---
layout: post
...
4. Download the `README` file, which is a textfile, and open it in a separate tab.
...
7. Now, in order to download a previous release, paste the link you saved under step 4.2 and swap out the filename before the extension with the respective `Package` identifier. For example, if I want to download UEFI version 1.30, 
